...
let dataArray = [];
let array_for_scrolling = [];

function data_for_scrolling() {
  dataArray[0] = data_for_scrolling1(0, 16);
  dataArray[1] = data_for_scrolling1(16, 33);
  dataArray[2] = data_for_scrolling1(33, 47);
  dataArray[3] = data_for_scrolling1(47, 57);
  dataArray[4] = data_for_scrolling1(57, 74);
  dataArray[5] = data_for_scrolling1(74, 86);
  dataArray[6] = data_for_scrolling1(86, 91);
  dataArray[7] = data_for_scrolling1(91, 100);
  dataArray[8] = data_for_scrolling1(100, 105);
  dataArray[9] = data_for_scrolling1(105, 115);
}

function data_for_scrolling1(x, y) {
  let tempArray1 = [];
  let tempArray2 = [];
  let tempArray3 = [];
  let resultArray = [];
  ...
  for (let i = x; i < y; i++) {
    for (let j = 0; j < 12; j++) {
      var attribute_name =
        data_for_queries[i].station_name +
        " -- " +
        data_for_queries[i].air_pollutant +
        " -- " +
        months[j] +
        " -- " +
        data_for_queries[i].scope_name_final +
        " (" +
        unit +
        ")";
      //console.log(attribute_name);
      tempArray1.push(attribute_name);
      tempArray2.push(values_for[i][j]);
      tempArray3.push(data_for_queries[i].air_pollutant);
    }
  }
  ...
  if (tempArray1.length === tempArray2.length) {
    for (let i = 0; i < tempArray1.length; i++) {
      const attributeObject = {
        attribute_name: tempArray1[i],
        attribute_value: tempArray2[i],
        attribute_category: tempArray3[i]
      };
...
for (let i = 0; i < cities.length; i++) {
  ...
  array_for_scrolling.push(attributeObject);
}

//console.log(dataArray);
//console.log(array_for_scrolling);



// Convert the array to a JSON string
const jsonString = JSON.stringify(array_for_scrolling, null, 2);
