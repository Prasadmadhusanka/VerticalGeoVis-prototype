...
let air_pollutant = [
  ...
  ["Fine dust (PM10)", "Nitrogen dioxide (NO2)", "Ozone (O3)"],
  [
    "Carbon monoxide (CO)",
    "Fine dust (PM10)",
    "Nitrogen dioxide (NO2)",
...
let row_number_indexes = [
  ...
  [[78], [74, 77, 81, 83], [76, 80, 82, 85], [75, 79, 84]],
  [[86, 88], [87, 90], [89]],
  [[91, 93, 97], [92, 96, 99], [94, 98], [95]],
  [[100, 102], [101, 104], [103]],
  [[105, 107, 109, 112], [106, 108, 111, 114], [110], [113]],
];
...
function d3_1(x, y) {
  ...
  attributeObject0 = {
    name: data_for_queries[x].scope_name_final + " (" + unit + ")",
    station: data_for_queries[x].station_name,
  ...
  attributeObject1 = {
    name: data_for_queries[x].station_name,
    children: tempArray0,
  };
...
a.download = "data_for_d3_um_new.json";
